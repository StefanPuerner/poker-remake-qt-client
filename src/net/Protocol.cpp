...
const char* msgTypeStr(MsgType t) {
  switch (t) {
    ...
    case MsgType::SINCRONIZAR_PROGRESO_OFFLINE:
      return "SINCRONIZAR_PROGRESO_OFFLINE";
    case MsgType::PROGRESO_OFFLINE_SINCRONIZADO:
      return "PROGRESO_OFFLINE_SINCRONIZADO";
...
MsgType strToMsgType(const std::string& s) {
  ...
  if (s == "SINCRONIZAR_PROGRESO_OFFLINE") return MsgType::SINCRONIZAR_PROGRESO_OFFLINE;
  if (s == "PROGRESO_OFFLINE_SINCRONIZADO") return MsgType::PROGRESO_OFFLINE_SINCRONIZADO;
