...
QtObject {
    ...
    readonly property var textos: ({
        ...
        "banda_allin": { es: "¡ALL-IN!   {0}", en: "ALL-IN!   {0}", de: "ALL-IN!   {0}" },
        "banda_ganas": { es: "¡GANAS!   +{0}", en: "YOU WIN!   +{0}", de: "DU GEWINNST!   +{0}" },
        "banda_gana_otro": { es: "{0} gana   +{1}", en: "{0} wins   +{1}", de: "{0} gewinnt   +{1}" },
        "banda_eliminado": { es: "{0} eliminado", en: "{0} eliminated", de: "{0} ausgeschieden" },
        "bote_etiqueta_principal": { es: "Principal {0}", en: "Main {0}", de: "Haupt {0}" },
        "bote_etiqueta_side": { es: "Side {0} {1}", en: "Side {0} {1}", de: "Side {0} {1}" },
        "bote_detalle_principal": { es: "Bote principal  ·  {0}", en: "Main pot  ·  {0}", de: "Hauptpot  ·  {0}" },
        "bote_detalle_side": { es: "Side pot {0}  ·  {1}", en: "Side pot {0}  ·  {1}", de: "Side Pot {0}  ·  {1}" },
        "bote_puso": { es: "puso {0}", en: "put in {0}", de: "setzte {0}" },
        "bote_gana": { es: "Gana {0}  (+{1})", en: "{0} wins  (+{1})", de: "{0} gewinnt  (+{1})" },
        ...
        "ajustes_sonidos_diagnostico": {
            es: "Sonidos: {0} cargados, {1} con error, {2} reproducidos",
            en: "Sounds: {0} loaded, {1} failed, {2} played",
            de: "Sounds: {0} geladen, {1} fehlerhaft, {2} abgespielt"
        },
        "ajustes_sonidos_probar": { es: "Probar", en: "Test", de: "Testen" },
        ...
        "sonido_grupo_resultado": { es: "Resultado (ganar, perder, eliminado)", en: "Result (win, lose, eliminated)", de: "Ergebnis (Gewinn, Verlust, Ausscheiden)" },
        "sonido_grupo_retirarse": { es: "Retirarse", en: "Folding", de: "Passen" },
        "sonido_grupo_turno": { es: "Aviso de tu turno", en: "Your-turn alert", de: "Signal für deinen Zug" },
        "ajustes_animaciones_titulo": { es: "ANIMACIONES DE LA MESA", en: "TABLE ANIMATIONS", de: "TISCH-ANIMATIONEN" },
        "animaciones_completas": { es: "Completas", en: "Full", de: "Voll" },
        "animaciones_reducidas": { es: "Reducidas", en: "Reduced", de: "Reduziert" },
        "animaciones_desactivadas": { es: "Desactivadas", en: "Off", de: "Aus" },
        "voto_continua_solo": { es: "La partida continúa sola en {0} s", en: "The game continues on its own in {0}s", de: "Das Spiel geht in {0} s automatisch weiter" },
        "boton_mostrar_cartas": { es: "Mostrar cartas", en: "Show cards", de: "Karten zeigen" },
        ...
        "etiqueta_temporizador_voto": {
            es: "Temporizador entre manos (si nadie vota en 60 s, la partida sigue sola)",
            en: "Timer between hands (if nobody votes within 60 s, the game continues)",
            de: "Timer zwischen den Händen (stimmt niemand innerhalb von 60 s ab, geht es weiter)"
        },
