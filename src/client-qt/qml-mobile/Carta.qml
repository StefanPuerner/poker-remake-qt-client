// Carta.qml (móvil) — una carta de la baraja (o su dorso, si no se pasa "codigo"). Espejo de la de
// escritorio (puramente informativa, sin ratón/hover); solo cambian el URI y el shader de dithering.
