// AnilloNivel.qml — anillo circular de progreso de nivel (XP), dibujado a
// mano con Canvas (arco relleno según fraccion), mismo criterio que
// IconoFicha.qml/PaloIcono.qml: sin depender de ningún componente de
// gráficos externo (QtQuick no trae un donut chart de fábrica). "Nivel N"
// se superpone como Text normal encima del Canvas -- así usa EB Garamond
// como el resto de la app en vez de tener que dibujar texto a mano.
